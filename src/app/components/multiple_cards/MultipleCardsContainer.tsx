...
function MultipleCardsContainer() {
  return (
    <div className='w-full px-8'>
      <div className='w-full bg-red-800 lg:h-[450px] flex lg:flex-row flex-col lg:gap-2 gap-y-2 px-3 '>
        <div className='md:w-1/4 w-fit flex flex-col gap-3 bg-cyan-800'>
          <div className='relative w-full md:h-[55%] h-[300px] transform transition duration-300 ease-in-out hover:scale-[1.03]'>
          ...
          <div className='h-[45%]'>
            <div className='h-full bg-[#E6F2D5] flex flex-col items-center justify-center p-2 rounded-3xl transform transition duration-300 ease-in-out hover:scale-[1.03]'>
              ...
              <p className='text-md font-semibold'>Rapid Access to Testing & Treatment</p>
              <p className='text-sm text-gray-800 pt-2'>We fast-track diagnostic procedures so you get clarity quickly. Early testing means faster decisions and better outcomes.</p>
            </div>
          </div>
        </div>
        <div className='md:w-1/4 w-fit flex flex-col gap-3'>
          ...
          <div className='h-[50%] transform transition duration-300 ease-in-out hover:scale-[1.03]'>
            <div className='h-full bg-[#DBE4F5] flex flex-col items-center justify-center p-2 rounded-3xl'>
              ...
              <p className='text-md font-semibold'>Book Remote Consultation</p>
              <p className='text-sm text-gray-800  pt-2'>Connect with leading urology specialists from the comfort of your home. Schedule appointments at your convenience—no travel or waiting rooms required.</p>
            </div>
          </div>
          <div className='h-[50%] transform transition duration-300 ease-in-out hover:scale-[1.03]'>
            <div className='h-full bg-[#F8F8F8] flex flex-col items-center justify-center p-2 rounded-3xl'>
              ...
              <p className='text-md font-semibold'>Personal Consultant Support</p>
              <p className='text-sm text-gray-800  pt-2'>Connect directly with the highly qualified Dr Erol  who prioritizes your health, providing compassionate, expert-led care that puts you first.</p>
            </div>
          </div>
        </div>
        <div className='md:w-1/4 w-fit flex flex-col gap-3 bg-green-200'>
          ...
          <div className='h-[50%] transform transition duration-300 ease-in-out hover:scale-[1.03]'>
            ...
            C305.304,259.959,241.059,324.198,162.099,324.198z" />
              ...
              <p className='text-md font-semibold z-10'>Seamless Coordination for Surgery</p>
              <p className='text-sm text-gray-800 z-10 pt-2'>Your privacy is our priority. All consultations, reports, and treatments are handled with complete confidentiality and data security.</p>
            </div>
          </div>
          <div className='h-[50%] transform transition duration-300 ease-in-out hover:scale-[1.03]'>
            <div className='relative overflow-hidden h-full bg-[#F8F8F8] flex flex-col items-center justify-center p-2 rounded-3xl'>
            ...
            C305.304,259.959,241.059,324.198,162.099,324.198z" />
              ...
              <p className='text-md font-semibold z-10'>Confidential & Secure Care</p>
              <p className='text-sm text-gray-800 z-10 pt-2'>If surgical intervention is needed, we handle it with speed and discretion. From scheduling to recovery, everything is managed smoothly.</p>
            </div>
          </div>
        </div>
        <div className='md:w-1/4 w-fit h-full flex flex-col gap-3'>
          <div className='h-[45%] transform transition duration-300 ease-in-out hover:scale-[1.03]'>
            <div className='h-full bg-[#FEF1CB] flex flex-col items-center justify-center p-2 rounded-3xl'>
              ...
              <p className='text-md font-semibold'>Direct Access to Expert Care</p>
              <p className='text-sm text-gray-80-1 pt-2'>You’ll never feel alone in your health journey. Your assigned consultant guides you through every step, ensuring confidence in your care.</p>
            </div>
          </div>
          <div className='relative w-full md:h-[55%] h-[300px] transform transition duration-300 ease-in-out hover:scale-[1.03]'>
            <Image src='/78f11931d8a5ea6a78ff6a53e518ee58ea0cb031.jpg' alt='happy old man' height={450} width={450} className='w-full h-full rounded-3xl object-cover' objectFit='center'></Image>
          </div>
        </div>
      </div>
    </div>
